...
@property (nonatomic, strong) YelpItemCell *prototypeCell;
...
- (void)viewDidLoad
{
    ...
    UINib *yelpItemCellNib = [UINib nibWithNibName:@"YelpItemCell" bundle:nil];
    [self.tableView registerNib:yelpItemCellNib forCellReuseIdentifier:@"YelpItemCell"];
    self.prototypeCell = [self.tableView dequeueReusableCellWithIdentifier:@"YelpItemCell"];
...
{
    YelpItemCell *cell = [tableView dequeueReusableCellWithIdentifier:@"YelpItemCell" forIndexPath:indexPath];
...
{
    return 95; // height of a row without wrapping title text
}
...
- (void)onFilterButton
{
    FilterSettingController *vc = [[FilterSettingController alloc] init];
